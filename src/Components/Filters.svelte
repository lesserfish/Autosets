<script>
  ...
  function FillEmpty() {
    if (ChosenMuscles.length == 0) {
      for (
        let i = 0;
        i < Object.values(AppObjects.muscleGroupArray).length;
        i++
      ) {
    ...
    if (ChosenEquipment.length == 0) {
      for (
        let i = 0;
        i < Object.values(AppObjects.equipmentArray).length;
        i++
      ) {
    ...
    if (ChosenDifficulty.length == 0) {
      for (
        let i = 0;
        i < Object.values(AppObjects.experienceArray).length;
        i++
      ) {
    ...
    if (ChosenTypes.length == 0) {
      for (
        let i = 0;
        i < Object.values(AppObjects.exerciseTypeArray).length;
        i++
      ) {
      ...
      <div class="modal-body">
        <div class="accordion accordion-flush" id="FilterAccordionFlush">
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingOne">
              <button
                ...
                data-bs-target="#Muscle-collapse"
                aria-expanded="false"
          ...
          <div
            ...
            data-bs-parent="#FilterAccordionFlush"
          >
              ...
              <div class="form-check">
                <input
                  ...
                  on:change={() => {
                    checkAll(
                      "allMuscles",
                      Object.values(AppObjects.muscleGroupArray)
                    );
                  }}
                  checked
                />
                <label class="form-check-label" for="muscle-group-1">
                  All
                </label>
              </div>
              {#each Object.values(AppObjects.muscleGroupArray) as muscleGroup, i}
                <div class="form-check">
                  <input
                    ...
                    value={muscleGroup}
                    id={muscleGroup}
                    bind:group={ChosenMuscles}
                  />
                  <label class="form-check-label" for={muscleGroup}>
                    {muscleGroup}</label
                  >
                </div>
              {/each}
              ...
              <div class="form-check">
                <input
                  ...
                  on:change={() => {
                    checkAll(
                      "allEquipment",
                      Object.values(AppObjects.equipmentArray)
                    );
                  }}
                  checked
                />
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingOne">
              <button
                ...
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#Difficulty-Collapse"
                aria-expanded="false"
                aria-controls="flush-collapseOne"
              >
                Difficulty:
              ...
              <div class="form-check">
                <input
                  ...
                  on:change={() => {
                    checkAll(
                      "allDifficulty",
                      Object.values(AppObjects.experienceArray)
                    );
                  }}
                  checked
                />
              ...
              <div class="form-check">
                <input
                  ...
                  on:change={() => {
                    checkAll(
                      "allTypes",
                      Object.values(AppObjects.exerciseTypeArray)
                    );
                  }}
                  checked
                />
